label arka3:
    ...
    "Бабушки гордятся своим внуком, ведь теперь Себастиан с высшим образованием и может сделать много полезного для своей Родины."
...
Надо изучить с какими библиотеками они работают"
    ...
    s  "Тинько от  Python-разработчик требует умение работать с FastApi, Flask, PostgreSQL и MySQL, опыт использования Kafka, Cassandra, Clickhouse, Redis и Elasticsearch. Надо их изучить."
    ...
    s "Обеденный перерыв. Можно обсудить с коллегами рабочие вопросы, новости it или просто поболтать на отстранённые темы и отдохнуть."
